...
{
    public class SpecialFilteringJoinedSubclassEntityPersister : JoinedSubclassEntityPersister
    {
        private readonly FilterHelper _filterHelper;

        public SpecialFilteringJoinedSubclassEntityPersister(PersistentClass persistentClass,

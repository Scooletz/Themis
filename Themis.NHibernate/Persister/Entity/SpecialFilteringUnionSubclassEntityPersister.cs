...
{
    public class SpecialFilteringUnionSubclassEntityPersister : UnionSubclassEntityPersister
    {
        private readonly FilterHelper _filterHelper;

        public SpecialFilteringUnionSubclassEntityPersister(PersistentClass persistentClass,
